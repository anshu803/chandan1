...
BOT_TOKEN = os.getenv("8827214752:AAGeObND4pSDeztVmj8A6dhNqisAlI4XX10", "PASTE_BOT_TOKEN_HERE")

# Private Telegram admin channel ID
ADMIN_CHANNEL_ID = int(
    os.getenv("6644342214", "-1001234567890")
)

# केवल अपनी UPI ID बदलनी है
UPI_ID = os.getenv("8303721228@ibl", "yourupi@upi")
...
<b>💰 सभी Codes की कीमत: ₹20</b>

<b>👇 अपनी Programming Language चुनें:</b>
""",
...
<b>अपनी पूरी requirement एक message में लिखें।</b>
...
<b>नीचे दिया QR scan करके ₹20 payment करें।</b>

<b>📸 Payment के बाद screenshot इसी bot को भेजें।</b>
""",
...
<b>कृपया लगभग 3 घंटे तक प्रतीक्षा करें।</b>

<b>Verification complete होने के बाद
आपको update मिलेगा।</b>
""",
...
""",
    ...
    bot.send_message(
        ADMIN_CHANNEL_ID,
        f"✅ Order <code>{order_id}</code> user को deliver कर दिया गया।",
        parse_mode="HTML"
    )
