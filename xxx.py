...
VERSION = "5.0"
DB_PATH = os.getenv("DB_PATH", "/var/data/anshu_ethicalx.db" if os.path.isdir("/var/data") else "anshu_ethicalx.db")
BOT_TOKEN = os.getenv("8827214752:AAGeObND4pSDeztVmj8A6dhNqisAlI4XX10", "").strip()

try:
    ADMIN_ID = int(os.getenv("6644342214", "0"))
except ValueError:
    ADMIN_ID = 0
...
def main():
    if ADMIN_ID <= 0:
        raise RuntimeError(
            "ADMIN_ID environment variable missing or invalid. "
